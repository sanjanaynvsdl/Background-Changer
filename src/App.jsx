      ...
      <div className='w-full h-screen  duration-200 ' style = {{background:color}}>
        <div className ='fixed flex flex-wrap justify-center bottom-12 inset-x-0 px-2'>
          <div className='flex flex-wrap justify-center bottom-12 gap-3 shadow-lg bg-white px-3 py-2 rounded-3xl'>
            <button onClick={()=> setColor('#E1EDEC')} className='outline-none px-4 py-1  rounded-full shadow-lg text-black font-bold'  style={{background:'#E1EDEC'}}>Misty Mint</button>
            ...
            <button onClick={()=>setColor('#A5A4B5')} className='outline-none px-4 py-1  rounded-full shadow-lg text-black font-bold' style={{background:'#A5A4B5'}}>Cloudy Blue</button>
